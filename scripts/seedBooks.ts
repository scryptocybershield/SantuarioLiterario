 ...
 */
async function fetchBookDetails(googleBooksId: string) {
  try {
 ...
 */
function createInstagramPost(bookData: any, seedConfig: any) {
 ...
 */
function createFirestoreBook(bookData: any) {
  return {
...
export { runSeed, BOOKS_TO_SEED, fetchBookDetails };